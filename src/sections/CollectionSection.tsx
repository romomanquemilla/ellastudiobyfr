...
const CollectionSection = ({ className = '' }: CollectionSectionProps) => {
  ...
  return (
    ...
    >
      <img
        src="./images/collection_seated.jpg"
        alt="Collection"
        className="bg-image"
        ...
        <div className="pt-[8vh] flex justify-between">
          <div className="max-w-[42vw]">
            ...
            <h2 className="font-serif text-cream text-[clamp(34px,3.6vw,56px)] leading-[1.05]">
              Designed for your body.<br />And your comfort.
            </h2>
          </div>
          
          <div className="max-w-[34vw] pt-[8vh]">
            <p className="text-cream/80 text-base md:text-lg leading-relaxed">
              A curated set of looks, lighting setups, and pacing options—so the session feels like a conversation, not a production.
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-[10vh] left-[6vw] right-[6vw] flex justify-between items-end">
          <div className="max-w-[30vw]">
            ...
            <p className="text-cream/70 text-sm leading-relaxed">
              Wardrobe guidance · Mood boards · Relaxed pacing
            </p>
          </div>
